...
SubmitButton.MouseButton1Click:Connect(function()
    ...
    if KeySystem == "HUB-XLCXEATWSDBKUMKO" then   
screenGui:Destroy()

--Your Script
loadstring(game:HttpGet(('https://raw.githubusercontent.com/timYTHuber/AllInOne/main/Hub.lua')))()
  end
end)

GetKeyButton.MouseButton1Click:Connect(function()
 setclipboard("https://luareseller.mysellix.io/ru/") 
end) 
